...
# KMedoids crucial parameters: n_clusters, metric, method, init, max_iter, random_state
kmedoids = KMedoids(n_clusters=4, metric='euclidean', method='alternate', init='heuristic', max_iter=300, random_state=0)
